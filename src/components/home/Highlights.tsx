...
const accents: Accent[] = [
  ...
  { glow: 'hover:shadow-glow-purple', icon: 'text-lavender-300', chip: 'group-hover:border-lavender-400/60',num: 'text-lavender-300', blob: 'bg-lavender-500/30', tint: 'from-lavender-500/[0.12]' },
            ...
            >
              ...
              <div className={cn('relative z-10 flex flex-col h-full', feature && 'sm:max-w-lg')}>
                <div className={cn('flex items-center justify-between mb-4', isRTL && 'flex-row-reverse')}>
                  <div className={cn('grid place-items-center w-12 h-12 rounded-xl border border-[var(--color-border)] bg-white/[0.04] transition-all duration-200 group-hover:-translate-y-0.5', a.chip, a.icon)}>
